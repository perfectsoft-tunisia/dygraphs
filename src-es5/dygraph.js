...
Dygraph.prototype.doZoomXDates_ = function (minDate, maxDate) {
  ...
  var yAxisRanges = this.yAxisRanges();

  var beforeZoomCallback = this.getFunctionOption('beforeZoomCallback');
  if (beforeZoomCallback) {
    if (beforeZoomCallback.call(this, minDate, maxDate, yAxisRanges) === false) {
      return;
    }
  }
  ...
  this.doAnimatedZoom(old_window, new_window, null, null, function () {
    if (zoomCallback) {
      zoomCallback.call(_this2, minDate, maxDate, yAxisRanges);
    }
  });
};
...
Dygraph.prototype.doZoomY_ = function (lowY, highY) {
  ...
  var _xAxisRange = this.xAxisRange();
  ...
  var beforeZoomCallback = this.getFunctionOption('beforeZoomCallback');
  if (beforeZoomCallback) {
    if (beforeZoomCallback.call(this, minX, maxX, newValueRanges) === false) {
      return;
    }
  }
  ...
  this.doAnimatedZoom(null, null, oldValueRanges, newValueRanges, function () {
    if (zoomCallback) {
      zoomCallback.call(_this3, minX, maxX, _this3.yAxisRanges()); //TODO: maybve directly use newValueRanges instead of this.yAxisRanges()
    }
  });
};
...
Dygraph.prototype.resetZoom = function () {
  ...
  if (beforeZoomCallback) {
    if (beforeZoomCallback.call(this, minDate, maxDate, this.yAxisExtremes()) === false) {
      return;
    }
  }
